...
SECRET_KEY = "django-insecure-xk0dwa^clgrw8uay%7id&glix)hyv8fts&gdhwklu_y54e29)_"
...
DATABASES = {
    'default': {
        ...
        'USER': 'root',
        'PASSWORD': '',
        'HOST': 'localhost',  # Puede cambiar según la ubicación de su base de datos MySQL
